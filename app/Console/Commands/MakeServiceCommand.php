...
");
        ...
        Route::group(['prefix' => '" . strtolower($name) . "'], function () {
            ...
            Route::get('/{id}/', [\App\Http\Controllers\\" . $service . "Controller::class, 'show']);
            Route::post('/', [\App\Http\Controllers\\" . $service . "Controller::class, 'create']);
            Route::put('/{id}', [\App\Http\Controllers\\" . $service . "Controller::class, 'update']);
            Route::delete('/{id}', [\App\Http\Controllers\\" . $service . "Controller::class, 'destroy']);
        });
        ");
